    ...
    <div class="layout-px-spacing">
        <div class="page-header">
            <div class="page-title">
                ...
                <a id="btn-compose-mail" class="btn-add"  data-toggle="modal" data-target="#addCategoryModal"
                                ...
                                <tr id="tr{{ $category->id }}">
                                    ...
                                    <td>
                                        <ul class="table-controls" style="text-align: center">
                                            <li><a href="javascript:void(0);" onclick="editCategory({{$category->id}})"
                                            ...
                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#deleteModal" onclick="getId({{$category->id}})"
