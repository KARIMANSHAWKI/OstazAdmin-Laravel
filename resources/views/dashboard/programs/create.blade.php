<div class="modal fade" id="addProgramModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex mail-to mb-4">
                                        ...
                                        <div class="w-100">
                                            <select class="multiSelect form-control" style="outline: hidden !important" name="countries[]" multiple>
                                                @foreach ($countries as $country)
                                                        <option value="{{$country->id}}">{{$country->name}}</option>
                                                @endforeach
                                            </select>
                                            <small id="countries_error" class="form-text text-danger"></small>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn editTrainer" id="createProgramBtn">Add</button>
            </div>
        </div>
    </div>
</div>
