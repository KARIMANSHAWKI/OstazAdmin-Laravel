    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex mail-to mb-4">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <small id="gander1_error" class="form-text text-danger"></small>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn editStudent" id="editStudentBtn">Edit</button>
            </div>
        </div>
    </div>
</div>
