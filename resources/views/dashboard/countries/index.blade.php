    ...
    <div class="layout-px-spacing">
        <div class="page-header">
            <div class="page-title">
                <h3 style="display: inline-block">Country</h3>
                <a id="btn-compose-mail" class="btn-add "  data-toggle="modal" data-target="#addCountryModal"
                                ...
                                <tr id="tr{{ $country->id }}">
                                    ...
                                    <td>
                                        <ul class="table-controls" style="text-align: center">
                                            <li><a href="javascript:void(0);" onclick="editCountry({{  $country->id }})"
                                            ...
                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#deleteModal" onclick="getId({{$country->id}})"
        ...
        @include('dashboard.countries.edit')
        @include('dashboard.countries.delete')
