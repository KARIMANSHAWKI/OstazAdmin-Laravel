    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="compose-box">
                    <div class="compose-content" id="addTaskModalTitle">
                        <h5 class="">Edit Country</h5>
                        <form  method="post"  id="editCountryForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex mail-to mb-4">
                                        <input type="hidden" name="id" id="idCountry">
                                        ...
                                        <div class="w-100">
                                            <input id="nameCountry" type="text"  class="form-control" name="name">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn editTrainer" id="editCountryBtn">Edit</button>
            </div>
        </div>
    </div>
</div>
