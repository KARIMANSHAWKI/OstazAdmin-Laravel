    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex mail-to mb-4">
                                        ...
                                        <div class="w-100">
                                            <input id="namePermission" type="text" class="form-control" name="name">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn editTrainer" id="editPermissionBtn">Edit</button>
            </div>
        </div>
    </div>
</div>
