            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left"  method="POST" action="{{route('dashboard.login.store')}}">
                            @csrf
                            <div class="form">
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('dashboard.login.store') }}">
                            {{ csrf_field() }}
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dashboard.login.index') }}">
                        @csrf
